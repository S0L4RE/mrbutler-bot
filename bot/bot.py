...
async def on_message(message):
    ...
    if message.content.startswith('!aboutme'):
        ...
        doc_block = (
            ...
            calling_user.discriminator,
            calling_user.mention,
            calling_user.avatar,
            calling_user.avatar_url,
            calling_user.default_avatar,
            calling_user.default_avatar_url,
            calling_user.bot,
            calling_user.created_at,
        )
